...
import com.suresh.employee_service.ExceptionHandling.CustomException;
import com.suresh.employee_service.ExceptionHandling.ExternalServiceException;
...
//	@Value("${address-service.base.url}")
	...
	public EmployeeDTO getEmployeeByRestTemplate(Long empId) throws Exception {
		try{
			...
			throw new ExternalServiceException("Exception for getting the address details");
		}catch (Exception e){
			throw  new Exception("Something happend here");
		}
	}
	...
	public EmployeeDTO getEmployeeByEmpId(Long empId) throws Exception {
		return getEmployeeByRestTemplate(empId);
		// have to implement in address also. check when you refer
	}
}
